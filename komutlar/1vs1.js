    ...
    while (userHP > 0 && oppoHP > 0) {
      ...
      if (!opponent.bot || (opponent.bot && userTurn)) {
        ...
        const filter = (res) =>
          ...
          ["saldır", "savun", "ultra güç", "kaç", "gay"].includes(
        ...
        const choices = ["saldır", "savun", "ultra güç", "kaç", "gay"];
      ...
      if (choice === "saldır") {
        ...
        const damage = Math.floor(Math.random() * (guard ? 99999 : 999999)) + 1;
        await message.channel.send(
          `${user} Gay Dedi Ve **${damage}** Hasar Vurdu `
        );
        dealDamage(damage);
        reset();
